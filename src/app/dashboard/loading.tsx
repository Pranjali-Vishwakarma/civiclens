  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-center items-center p-6 gap-4 font-sans">
      ...
      <div className="text-center">
        <h3 className="text-md font-bold text-slate-300">Loading Dashboard...</h3>
        <p className="text-xs text-slate-500 mt-1 animate-pulse">Compiling real-time civic health score analytics</p>
      </div>
    </div>
  );
}
